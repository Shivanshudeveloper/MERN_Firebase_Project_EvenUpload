        ...
        <div>
            {
                fileExtension === 'png' || fileExtension === 'jpeg' || fileExtension === 'jpg' ? (
                    <div style={{float: 'left'}} >
                        <i aria-hidden="true" className="file image alternate big icon purple aligned"></i>{file_name.split("_").pop().substring(0, 10)}....
                    </div>
                ) : (
                    fileExtension === 'xls' || fileExtension === 'xlsx' || fileExtension === 'csv' || fileExtension === 'ods' || fileExtension === 'xlsb' || fileExtension === 'tsv' || fileExtension === 'dif' ? ( 
                        <div style={{float: 'left'}} >
                            <i aria-hidden="true" className="file excel alternate big icon green aligned"></i>{file_name.split("_").pop().substring(0, 10)}....
                        </div>
                    ) : fileExtension === 'docx' || fileExtension === 'doc' || fileExtension === 'wps' ? ( 
                        <div style={{float: 'left'}} >
                            <i aria-hidden="true" className="file word alternate big icon blue aligned"></i>{file_name.split("_").pop().substring(0, 10)}....
                        </div>
                    ) : fileExtension === 'pdf' ? ( 
                        <div style={{float: 'left'}} >
                            <i aria-hidden="true" className="file red pdf big icon aligned"></i>{file_name.split("_").pop().substring(0, 10)}....
                        </div>
                    ) : fileExtension === 'pptx' || fileExtension === 'pptm' || fileExtension === 'ppt' || fileExtension === 'pot' || fileExtension === 'ppsx' ? ( 
                        <div style={{float: 'left'}} >
                            <i aria-hidden="true" className="file orange powerpoint big icon aligned"></i>{file_name.split("_").pop().substring(0, 10)}....
                        </div>
                        ...
                        <div style={{float: 'left'}} >
                            <i aria-hidden="true" className="file olive video big icon aligned"></i>{file_name.split("_").pop().substring(0, 10)}....
                        </div>
                        ...
                        <div style={{float: 'left'}} >
                            <i aria-hidden="true" className="file archive brown big icon aligned"></i>{file_name.split("_").pop().substring(0, 10)}....
                        </div>
                    ) : (
                        <div style={{float: 'left'}} >
                            <i aria-hidden="true" className="file grey alternate big icon aligned"></i>{file_name.split("_").pop().substring(0, 10)}....
                        </div>
                    )
                )
            }
